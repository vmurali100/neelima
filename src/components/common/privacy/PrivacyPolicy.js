                ...
                <div className="col-lg-12 offset-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div className="row">
                        <div className="col-lg-12 offset-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            your driver's license or other identifying documents.</p>
                            <h6>Please see our <a href="#">Privacy Policy</a> for more information on how we useand keep your information safe.</h6>
